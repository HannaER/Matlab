...
s.reflec = db;
current_database = [current_database s];
load Hanna_db/database/r13.mat;
s.name = 'right';
s.reflec = db;
current_database = [current_database s];
load Hanna_db/database/r14.mat;
s.name = 'right';
s.reflec = db;
current_database = [current_database s];
...
s.reflec = db;
current_database = [current_database s];
load Hanna_db/database/l13.mat;
s.name = 'left';
s.reflec = db;
current_database = [current_database s];
load Hanna_db/database/l14.mat;
s.name = 'left';
s.reflec = db;
current_database = [current_database s];
load Hanna_db/database/l15.mat;
s.name = 'left';
s.reflec = db;
current_database = [current_database s];
