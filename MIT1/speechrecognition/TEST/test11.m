...
if decibel_diff < 0
    engine_noise.ch1 = decibel_inc_dec(engine_noise.ch1, decibel_diff);
    engine_noise.ch2 = decibel_inc_dec(engine_noise.ch2, decibel_diff);
    engine_noise.ch3 = decibel_inc_dec(engine_noise.ch3, decibel_diff);
    engine_noise.ch4 = decibel_inc_dec(engine_noise.ch4, decibel_diff);
...
if decibel_diff < 0
    factory_noise.ch1 = decibel_inc_dec(factory_noise.ch1, decibel_diff);
    factory_noise.ch2 = decibel_inc_dec(factory_noise.ch2, decibel_diff);
    factory_noise.ch3 = decibel_inc_dec(factory_noise.ch3, decibel_diff);
    factory_noise.ch4 = decibel_inc_dec(factory_noise.ch4, decibel_diff);
