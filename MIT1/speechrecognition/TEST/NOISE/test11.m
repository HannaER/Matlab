...
M = 54;%20; % antal brusnivåer, mätpunkter/kurva
...
ch1 = noise.segments(1,4).ch1;
ch2 = noise.segments(1,4).ch2;
ch3 = noise.segments(1,4).ch3;
ch4 = noise.segments(1,4).ch4;
