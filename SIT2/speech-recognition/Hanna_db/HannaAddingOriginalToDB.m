...
add_to_db(rec, 'Hanna_db/database/l13', L, D, P, M, 8000, GAMMA, 0);

load Hanna_db/original/v14.mat
add_to_db(rec, 'Hanna_db/database/l14', L, D, P, M, 8000, GAMMA, 0);

load Hanna_db/original/v15.mat
add_to_db(rec, 'Hanna_db/database/l15', L, D, P, M, 8000, GAMMA, 0);
...
add_to_db(rec, 'Hanna_db/database/r13', L, D, P, M, 8000, GAMMA, 0);

load Hanna_db/original/h14.mat
add_to_db(rec, 'Hanna_db/database/r14', L, D, P, M, 8000, GAMMA, 0);

load Hanna_db/original/h15.mat
add_to_db(rec, 'Hanna_db/database/r15', L, D, P, M, 8000, GAMMA, 0);
