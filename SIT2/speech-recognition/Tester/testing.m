%%%%%%%%%%% testar vad smällar i bord ligger på före frekvsener%%%%%%%%
...
%% Undersöker huruvida pre_emph och rm_noise tar bort störningarna
clc;
% close all;
% clear all;
...
%% Ska testa lägga till filter och undersöka om störningarna dämpas mer
clc;
close all;
clear all;
